...
//the $(document).ready block won't work. 
    ...
    function Shaker(diceCube) {     
        ...
        const speed = getRandom(5, 12);//best speed is between 5 and 12.
        const rotation = 360;//this value cannot be other than 360 to have the right dice number!
        let xRotation = speed*rotation;
        let yRotation = speed*rotation;
        ...
        function ResetRotation(diceCube) {  
            ...
            diceCube.style.webkitTransform = 'rotateX(' + 360 + 'deg) rotateY(' + 360 + 'deg)';
            diceCube.style.transform = 'rotateX(' + 360 + 'deg) rotateY(' + 360 + 'deg)';  
            diceCube.style.webkitTransform = 'rotateX(' + -360 + 'deg) rotateY(' + -360 + 'deg)';
            diceCube.style.transform = 'rotateX(' + -360 + 'deg) rotateY(' + -360 + 'deg)';  
